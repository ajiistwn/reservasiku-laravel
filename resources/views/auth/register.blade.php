<x-layouts.app>
    @if ($errors->any())
    <div class="fixed z-50 w-full max-w-md transform -translate-x-1/2 top-4 left-1/2" id="alert">
        <div class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-200 rounded-lg bg-red-50 dark:text-red-400 dark:bg-red-200 dark:border-red-800" role="alert" id="alertBox">
